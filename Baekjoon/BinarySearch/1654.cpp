...
hint : 802cm 랜선에서 4개, 743cm 랜선에서 3개, 457cm 랜선에서 2개, 539cm 랜선에서 2개를 잘라내 모두 11개를 만들 수 있다.

*/

#define MAXSIZE 10001
int arr[MAXSIZE];
int n, k, maxValue=0,result=0;

void BinarySearch()
{
    long long begin = 1, end = maxValue;

    while (begin<= end)
    {
        long long mid = (begin + end) / 2, cnt=0;
